...
namespace Windy.WebMVC.Web2.Areas.Admin.Controllers
{
    ...
    public class InviteController : Controller
    {
        ...
        public ActionResult QueryData()
        {
            ...
            int totalCount = 0;
            var result = EnterRepository.GetRepositoryEnter().InviteRepository.LoadPageList(tel, name, (page - 1) * size, size, out totalCount).ToList();
            ...
            try
            {
                ...
                if (selectID != string.Empty && selectID != "0")
                {
                    ...
                    foreach (var item in ids)
                    {
                        ...
                        EnterRepository.GetRepositoryEnter().InviteRepository.DeleteEntity(new Invite() { ID = id });
                    }
